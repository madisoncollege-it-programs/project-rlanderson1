...
def IPLookup(ip_address):
    ...
    print("Calling URL:", url) #Print the URL for verification
...
#def IPAddressCount(apache_log_file_name):  #Arguement
    ...
    r#esult = subprocess.run(command, stdout=subprocess.PIPE, shell=True)  # pass in the command , stndout is able to access data,  and then Pythhon is going to open a diff. shell to run this process w/o make it a list
...
def main():
    ...
    #Print values for 'org' and 'city' keys
    print("Organization:", data_dict['org'])
